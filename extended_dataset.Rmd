...
#     rotary_engine = ifelse(cylinders == "rotary", TRUE, FALSE), 
#     cylinders = as.numeric(ifelse(cylinders == "rotary", NA, cylinders))
#   )
# 
# write.csv(dougscore, "~/Desktop/dougscore-dataset/dougscore.csv")
# ```
