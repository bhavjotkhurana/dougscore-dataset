...
get_car_summary_llm <- function(df, query, engine = "gpt-3.5-turbo") {
  ...
  res <- httr::POST(
    ...
    body = jsonlite::toJSON(list(
      model = engine,
      messages = list(
        list(role = "system", content = "You are Doug DeMuro. You review cars with a mix of enthusiasm, detail, and humor. Your reviews focus on quirky features, fun vs. practicality, and end with a DougScore reference. Write in your classic voice."),
...
```{r}
get_car_summary_llm(dougscore, "Tesla Model S")
```
